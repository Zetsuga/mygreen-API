...
function getTarea(request,response){
    if(request.query.id_finca != null){
        ...
        sql = "SELECT * FROM tareas AS t JOIN usuario AS u ON (u.id_usuario = t.id_usuario) WHERE id_finca = ?";
    }else if(request.query.id_usuario != null){
        param = [request.query.id_usuario];
        sql = "SELECT * FROM tareas AS t JOIN usuario AS u ON (u.id_usuario = t.id_usuario) WHERE id_usuario = ?";
    }else{
        param = [request.query.id_tarea];
        sql = "SELECT * FROM tareas AS t JOIN usuario AS u ON (u.id_usuario = t.id_usuario) WHERE id_tarea = ?";
    }
